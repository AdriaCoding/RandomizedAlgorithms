...
𝒞_4(ν) = -48*Q(ν)* ln(1 - ν) + ρ([198, -956, 1890, -2000, 1236, -440, 68], ν)*ln(1 - ν)-20/3*ν^9 + 30*ν^8 - 170/3 * ν^7 + 1/3 *ρ([-456, 2352, -3641, 2756, -1146, 204], ν)
...
f1(x, ν) = C_1(ν)*(1/6 * x^3 + 1/2 * x^2 - x - (1-x)*ln(1-x)) + C_2(ν)*h(x) + C_3(ν)*x  
